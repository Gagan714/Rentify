    ...
    <div className="bg-black sticky-top text-white flex justify-around items-center h-16">
      <div><Link to="/" className="font-bold text-4xl no-underline text-white">Rentify
        ...
        <div className="flex justify-center gap-4 items-center text-white">
          ...
          <div><Link to="/requests" className="no-underline text-white">
          <button type="button" class="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-3xl text-sm px-3 py-2 text-center ">Requests</button>
          </Link></div>
          <div><Link to="/" onClick={handleLogout} className="no-underline text-white">
